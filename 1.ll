...
LU18:
	...
	%u35 = call i8* @malloc()
	%u36 = bitcast i8* %u35 to %struct.B
	%u34 = call i32 @g(i32 1, i32 %u36)
	%u37 = call i8* @malloc()
	%u38 = bitcast i8* %u37 to %struct.B
	%u33 = call %struct.A @f(i32 %u34, i32 %u38)
	%u39 = getelementptr %struct.A* %u33, i1 0, i32 0
	%u40 = load i32* %u39
	call void @printf_newline(i32 %u40)
	store i32 0, i32* %_retval_
	br label %LU9
LU9:
	%u41 = load i32* %_retval_
	ret i32 %u41
}
